...
void ExportShapeToSTL(const TopoDS_Shape& shape, const std::string& filename) {
    ...
    // 1. Calculate total number of triangles
    ...
    // 2. Manually write Binary STL to bypass any OpenCASCADE version inconsistencies
    ...
    // 3. Write each triangle (50 bytes each)
